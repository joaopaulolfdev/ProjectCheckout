...
import ProductRequest from '../../services/Request/Product';
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <img className="img-fluid rounded mb-4" src="https://via.placeholder.com/500x500" alt="Produto" />
                            </div>
                            <div className="col-lg-6">
                                ...
                                >
                                    {itemIsInCart ? "Já está no Carrinho" : "Adicionar no Carrinho"}
                                </button>
                            </div>
                        </div>
                    </div>
